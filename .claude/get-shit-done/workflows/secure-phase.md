...
```
Task(
  prompt="Read /Users/cupist/workspace/slw/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/cupist/workspace/slw/.claude/get-shit-done/templates/SECURITY.md`
