...
```bash
INIT=$(node "/Users/cupist/workspace/slw/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/cupist/workspace/slw/.claude/get-shit-done/templates/spec.md.
